...
Finfit은 사용자의 수입과 지출을 효율적으로 관리하고 월별 통계와 카테고리별 요약을 제공하여
재무 습관을 개선하는 것을 목표로 한 개인 재무 관리 웹 애플리케이션입니다.

Spring Boot와 JPA를 기반으로 한 계층형 구조 설계 (Controller - Service - Repository) 와
Spring Security 인증 체계를 적용하여, 실무 수준의 보안과 유지보수성을 갖춘 서비스를 구현했습니다.
